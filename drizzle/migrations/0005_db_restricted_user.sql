...
CREATE USER tstore_app WITH PASSWORD 'DefinaUmaSenhaSeguraAqui123!';
...
GRANT SELECT, INSERT, UPDATE, DELETE ON ALL SEQUENCES IN SCHEMA public TO tstore_app;
...
ALTER DEFAULT PRIVILEGES IN SCHEMA public GRANT SELECT, INSERT, UPDATE, DELETE ON SEQUENCES TO tstore_app;
